...
# %matplotlib inline
#For example of Sample 5, this can be used for all the other samples. Check the shape of the images and they slightly differ form samples to samples. 
...
"""Assiging images from image to their respective clusters"""
