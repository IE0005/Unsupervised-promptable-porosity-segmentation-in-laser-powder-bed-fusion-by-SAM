...
#cluster_1
def main():
    image_path = "/centers/thresholded_centroid_cluster_1.png"  # Replace this with the actual path of your image file
    #image_path = th5
...
for filename in os.listdir(image_folder):
    if filename.endswith('.tif'):  # Assuming your images have a .tif extension
        ...
        folder_path = ".../sample_5/pred_masks_np_arrays_seg/cluster_1"
        csv_folder = "..../sample_5"
        os.makedirs(csv_folder, exist_ok=True)

        # Create a CSV file to store scores
        csv_filename = "mask5_scores_1.csv"
        ...
        output_folder = '.../sample_5/pred_mask_final_seg/cluster_1'
...
csv_folder = '.../sample_5/CSV'

# Save Dice coefficients and image pairs to a CSV file in the specified folder
csv_filename = os.path.join(csv_folder, 'sample_5_k_means_seg_cluster_1.csv')
...
#cluster_2
def main():
    image_path = "..../sample_5/centers/thresholded_centroid_cluster_2.png"  # Replace this with the actual path of your image file
    #image_path = th5
    white_pixel_coordinates = get_white_pixel_coordinates(image_path)
    print(len(white_pixel_coordinates))
    #print(white_pixel_coordinates)
...
labels_100 = np.array(points)[indices]
image_folder = '.../sample_5/cluster_2'
# Iterate over each file in the folder
...
for filename in os.listdir(image_folder):
    if filename.endswith('.tif'):  # Assuming your images have a .tif extension
        ...
        # Create a folder to save the mask files
        folder_path = ".../sample_5/pred_masks_np_arrays/cluster_2"
        csv_folder = ".../SAM/Kmeans/sample_5"
        os.makedirs(csv_folder, exist_ok=True)
        ...
        # Save the final mask in the folder
        output_folder = '..../sample_5/pred_mask_final_seg/cluster_2'
        output_filename = f"{base_filename}.png"
        output_path = os.path.join(output_folder, output_filename)
...
# Save Dice coefficients and image pairs to a CSV file in the specified folder
csv_filename = os.path.join(csv_folder, 'sample_5_k_means_seg_cluster_2.csv')
...
#cluster_3
def main():
    image_path = "..../sample_5/centers/thresholded_centroid_cluster_3.png"  # Replace this with the actual path of your image file
    #image_path = th5
    white_pixel_coordinates = get_white_pixel_coordinates(image_path)
    print(len(white_pixel_coordinates))
    #print(white_pixel_coordinates)
...
labels_100 = np.array(points)[indices]
image_folder = '.../sample_5/cluster_3'
# Iterate over each file in the folder
...
for filename in os.listdir(image_folder):
    if filename.endswith('.tif'):  # Assuming your images have a .tif extension
        ...
        # Create a folder to save the mask files
        folder_path = "..../sample_5/pred_masks_np_arrays/cluster_3"
        csv_folder = "/sample_5"
        os.makedirs(csv_folder, exist_ok=True)
...
# Save Dice coefficients and image pairs to a CSV file in the specified folder
csv_filename = os.path.join(csv_folder, 'sample_5_k_means_seg_cluster_3.csv')
